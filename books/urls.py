...
urlpatterns = [
    ...
    path(
        "panel/books/regenerate-all-thumbnails/",
        views.panel_regenerate_all_thumbnails,
        name="panel-regenerate-all-thumbnails",
    ),
    path(
        "panel/books/<int:book_id>/edit/", views.panel_book_edit, name="panel-book-edit"
    ),
    path(
        "panel/books/<int:book_id>/delete/",
        views.panel_book_delete,
        name="panel-book-delete",
    ),
    path(
        "panel/books/<int:book_id>/cover/",
        views.panel_book_cover_upload,
        name="panel-book-cover",
    ),
    path(
        "panel/books/<int:book_id>/previews/",
        views.panel_book_preview_upload,
        name="panel-book-previews",
    ),
    path(
        "panel/books/<int:book_id>/regenerate-thumbnail/",
        views.panel_regenerate_thumbnail,
        name="panel-regenerate-thumbnail",
    ),
    path(
        "panel/books/image/<int:image_id>/delete/",
        views.panel_book_image_delete,
        name="panel-book-image-delete",
    ),
    path("panel/users/", views.panel_users, name="panel-users"),
    path(
        "panel/users/<int:user_id>/delete/",
        views.panel_user_delete,
    ...
    path(
        "panel/promos/<int:promo_id>/edit/",
        views.panel_promo_edit,
        name="panel-promo-edit",
    ),
    path(
        "panel/promos/<int:promo_id>/delete/",
        views.panel_promo_delete,
        name="panel-promo-delete",
    ),
    # ── User Auth ──
    ...
    path(
        "shop/cart/checkout/",
        views.razorpay_create_cart_order,
        name="razorpay-create-cart-order",
    ),
    path(
        "shop/cart/verify/",
        views.razorpay_verify_cart_payment,
        name="razorpay-verify-cart-payment",
    ),
    path(
        "shop/book/<int:book_id>/checkout/",
        views.razorpay_create_order,
        name="razorpay-create-order",
    ),
    path(
        "shop/book/<int:book_id>/verify/",
        views.razorpay_verify_payment,
        name="razorpay-verify-payment",
    ),
    path(
        "shop/book/<int:book_id>/download/", views.download_book, name="download-book"
    ),
    # ── SEO ──
    ...
    path(
        "api/cart/remove/<int:book_id>/", views.api_cart_remove, name="api-cart-remove"
    ),
    path("api/transactions/", views.api_transactions, name="api-transactions"),
    path(
        "api/transactions/<int:txn_id>/",
